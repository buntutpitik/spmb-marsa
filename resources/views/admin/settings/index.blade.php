                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm leading-6 text-slate-500">
                            Nama sekolah, NPSN, alamat, kontak, kepala sekolah,
                            logo, dan informasi institusi.
                        </p>
                    </div>
                </div>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm leading-6 text-slate-500">
                            Kelola daftar SMP/MTs yang muncul pada pilihan
                ...
                <div class="mt-5">
                    ...
                    <a
                        href="{{ route('admin.origin-schools.index') }}"
            ...
            <div class="rounded-2xl border border-emerald-200 bg-white p-6 shadow-sm">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm leading-6 text-slate-500">
                            Tambah, edit, aktifkan, nonaktifkan, dan atur pilihan
                            keringanan atau prestasi per periode.
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-5">
                <a
                    href="{{ route('admin.relief-options.index') }}"
            ...
            <div class="rounded-2xl border border-emerald-200 bg-white p-6 shadow-sm">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm leading-6 text-slate-500">
                            Kelola program seperti KKO dan Pondok Pesantren,
                            termasuk ketersediaannya pada setiap periode SPMB.
                        </p>
                    </div>
                ...
                <div class="mt-5">
                    ...
                    <a
                        href="{{ route('admin.special-programs.index') }}"
                        class="inline-flex items-center gap-2 text-sm font-semibold text-emerald-600 transition hover:text-emerald-700"
                    >
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-blue-900">
                        Konfigurasi berbasis periode
                    </h3>

                    <p class="mt-1 text-sm leading-6 text-blue-800">
                        Perubahan konfigurasi periode berikutnya tidak akan
                        mengubah histori pendaftaran pada periode sebelumnya.
                    </p>
                </div>
            </div>
        </div>
