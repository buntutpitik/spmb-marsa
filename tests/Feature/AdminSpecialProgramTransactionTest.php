...
class AdminSpecialProgramTransactionTest extends TestCase
{
    ...
    public function test_store_rolls_back_master_and_pivot_when_activity_log_fails(): void
    {
        ...
        $schoolId = DB::table('schools')->insertGetId([
            'name' => 'SMK SPECIAL PROGRAM TRANSACTION TEST',
            'npsn' => '79797979',
            'address' => null,
            'village' => null,
            'district' => null,
        ...
        $specialProgramId = DB::table('special_programs')
            ->where('name', 'ROLLBACK SPECIAL PROGRAM')
            ->value('id');

        $this->assertNull($specialProgramId);
